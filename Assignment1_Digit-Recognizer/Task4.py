...
image_transform = torchvision.transforms.Compose([
  torchvision.transforms.ToTensor(), torchvision.transforms.Normalize(mean=0.5, std=0.25)
])
...
# Plot loss
utilz.plot_loss(train_loss_dict, label="Train Loss")
utilz.plot_loss(val_loss_dict, label="Test Loss")
plt.ylim([0, 1])
plt.legend()
...
final_loss, final_acc = utilz.compute_loss_and_accuracy(
